...
await clickCloseIfPresent(page);
    ...
    //23913
        await page.goto('https://luckystake.dev/game/real/23913');
  ...
  screenshot = await page.screenshot({ fullPage: true });
    ...
    //35552
await page.goto('https://luckystake.dev/game/real/35552');
        // screenshot before Play now button
        screenshot = await page.screenshot({ fullPage: true });
...
//38798
await page.goto('https://luckystake.dev/game/real/38798');
        // screenshot before Play now button
        screenshot = await page.screenshot({ fullPage: true });
...
//40479
await page.goto('https://luckystake.dev/game/real/40479');
        // screenshot before Play now button
        screenshot = await page.screenshot({ fullPage: true });
...
//23978
await page.goto('https://luckystake.dev/game/real/23978');
        // screenshot before Play now button
        screenshot = await page.screenshot({ fullPage: true });
...
//23969
await page.goto('https://luckystake.dev/game/real/23969');
        // screenshot before Play now button
        screenshot = await page.screenshot({ fullPage: true });
  ...
  //23906
  await page.goto('https://luckystake.dev/game/real/23906');
        // screenshot before Play now button
        screenshot = await page.screenshot({ fullPage: true });
