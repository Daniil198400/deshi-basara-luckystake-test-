...
try {
  await page.waitForLoadState('networkidle', { timeout: 450000 }); 
} catch (e) {
  console.warn('Network idle is not found after 50 sec, keep going...');
}
...
test('@providersDev Trigger', async ({ page }) => {
     /**
