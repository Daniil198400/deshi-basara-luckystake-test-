...
test('@Regress luckystake promotions test', async ({ page }) => {
...
await delay5Seconds();
screenshot = await page.screenshot({ fullPage: true });
    test.info().attach(`selected promotion`, {
      body: screenshot,
      contentType: 'image/png',
    });
...
await delay5Seconds();
screenshot = await page.screenshot({ fullPage: true });
    test.info().attach(`terms and conditions`, {
      body: screenshot,
      contentType: 'image/png', 
    });
await delay5Seconds();
...
await delay5Seconds();
screenshot = await page.screenshot({ fullPage: true });
    test.info().attach(`my promotions`, {
      body: screenshot,
      contentType: 'image/png',
    });
