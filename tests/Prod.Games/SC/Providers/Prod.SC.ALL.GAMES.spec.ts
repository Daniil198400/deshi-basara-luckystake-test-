...
// try {
//   await page.waitForLoadState('networkidle', { timeout: 45000 }); // 45 секунд
// } catch (e) {
//   console.warn(' Network idle is not found after 30 sec, keep going...');
//   // continue – next steps
// }
...
// try {
//   await page.waitForLoadState('networkidle', { timeout: 30000 }); // 45 секунд
// } catch (e) {
//   console.warn('Network idle is not found after 30 sec, keep going...');
//   // continue – next steps
// }
...
// the very Test
test('PROD, SC ONLY, ALL GAMES', async ({ page }) => {
