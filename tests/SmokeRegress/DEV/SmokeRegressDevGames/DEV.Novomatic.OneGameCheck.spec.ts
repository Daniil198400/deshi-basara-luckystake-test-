...
await delay5Seconds();
  ...
  await page.goto('https://luckystake.dev/game/real/23933');
...
screenshot = await page.screenshot({ fullPage: true });
      test.info().attach('game_after_search_button', { body: screenshot, contentType: 'image/png' });
